      ...
      <div className="profile-modal">
        <article className="br3 ba  b--black-10 mv4 w-100 w-50-m w-25-l mw6 center shadow-5 bg-white">
          <main className="pa4 black-80 w-80">
            ...
            <input onChange={this.onFormChange} className='pa2 mb3 ba w-100' type="text" name="user-name" placeholder={user.name} id="name" />

            <label className='mt2 fw6' htmlFor="user-age">Age</label>
            <input onChange={this.onFormChange} className="pa2 mb3 ba w-100" type="number" name="user-age" placeholder={user.age} id="age" />

            <label className="mt2 fw6" htmlFor="user-pet">Pet</label>
            <input onChange={this.onFormChange} className="pa2 mb3 ba w-100" type="text" name="user-pet" placeholder={user.pet} id="pet" />
